...
def set_style_font(style, east_asia, ascii_font=None, size=None, bold=None):
    font = style.font
...
def configure_document():
    ...
    set_style_font(normal, east_asia="SimSun", ascii_font="Times New Roman", size=12, bold=False)
    ...
    set_style_font(body_text, east_asia="SimSun", ascii_font="Times New Roman", size=12, bold=False)
    ...
    set_style_font(first_paragraph, east_asia="SimSun", ascii_font="Times New Roman", size=12, bold=False)
    ...
    set_style_font(block_text, east_asia="SimSun", ascii_font="Times New Roman", size=12, bold=False)
    ...
    set_style_font(quote, east_asia="SimSun", ascii_font="Times New Roman", size=12, bold=False)
    ...
    set_style_font(heading1, east_asia="SimHei", ascii_font="Times New Roman", size=15.5, bold=True)
    ...
    set_style_font(heading2, east_asia="SimHei", ascii_font="Times New Roman", size=14, bold=True)
    ...
    set_style_font(heading3, east_asia="SimHei", ascii_font="Times New Roman", size=12, bold=True)
    ...
    set_style_font(table_style, east_asia="SimSun", ascii_font="Times New Roman", size=12, bold=False)

    table_para = ensure_style(doc, "Table Paragraph", WD_STYLE_TYPE.PARAGRAPH, normal)
    set_style_font(table_para, east_asia="SimSun", ascii_font="Times New Roman", size=12, bold=False)
